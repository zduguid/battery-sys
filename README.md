...
* If the user turns on one or two loads, the voltage and current values of the power supply will be set to zero. This is to prevent charge and discharge behavior to occur at the same time 
